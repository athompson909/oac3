app.directive('articleViewer', ['$window', function ($window) {
    ...
    return {
        ...
        template: '<div class="viewer-main main-blog" style={{mainStyle}}>' +
                '<div id="viewer-left" style={{leftStyle}}>' +
                    '<hr/> ' +
                    '<div class="title-div-article">{{articleType}}</div> ' +
                    '<hr/> ' +
    ...
    function link(scope, element, attrs) {
        ...
        scope.innerTitleStyle = getInnerTitleStyle();
        ...
        function getInnerTitleStyle() {
            return scope.wide ? "text-align: center;font-family: 'Permanent Marker', cursive;font-size: 54px;"
                : "text-align: center;font-family: 'Permanent Marker', cursive;font-size: 38px;";
        }
    }
}]);